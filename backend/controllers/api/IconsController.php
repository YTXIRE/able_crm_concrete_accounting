...
class IconsController extends Controller
{
    ...
    /**
     * @OA\Get(
     *     path="/api/icons/get-all",
     *     summary="Получение всех иконок",
     *     operationId="get-all",
     *     tags={"icons"},
     *     @OA\Parameter(
     *         name="token",
    ...
    function actionGetAll($token = '', $user_id = 0, $limit = 0, $offset = 0): Response
    {
        try {
            ...
            $icons = Icons::getAll($limit, $offset);
            return General::success(['icons' => $icons ?: [], 'count' => Icons::getAllCount()], $request, $this);
        } catch (Exception $e) {
